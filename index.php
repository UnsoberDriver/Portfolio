...
<head>
    ...
    <meta name="description" content="Portfolio de Nicolas Boulloud, étudiant en Multimédia et Technologies de l'Internet à Tarbes, passionné de développement web et de création d'expériences numériques modernes et accessibles.">
...
<body>
    ...
    <header>
        ...
        <div class="hero-title-wrap">
            <div class="hero-title">
                <p class="p1"><span class="p1-line">NICOLAS</span> <span class="p1-line p1-line-name">BOULLOUD</span></p>
                <p class="p1 p1-echo" aria-hidden="true"><span class="p1-line">NICOLAS</span> <span class="p1-line p1-line-name">BOULLOUD</span></p>
            </div>
        </div>
    ...
    <section id="about" class="border">
        ...
        <div class="profile-block">
            ...
            <div class="profile-text">
                ...
                <p class="p3">Second-year student in Multimedia and Internet Technologies at the Institute of Technology of
                    Tarbes. Passionate about web development and design, I create intuitive and aesthetic user experiences by
                    combining design and development. I am seeking a work-study position for my third year to further develop my
    ...
    <section id="realisations" class="border">
        ...
        <div class="projects-grid">
            ...
            <a class="project-card-link" href="https://romanbg.itch.io/maze-gate-of-hell" target="_blank"
                ...
                <article class="project-card">
                    <img class="project-media" src="./icones/image.avif" alt="Système de vote" width="800" height="220" loading="lazy">

                    <div class="project-content">
                        <h3>Scratch game</h3>

                        <p>
                            Maze: Gate of hell is a 2D escape game made for a scholl project.
                        </p>
            ...
            <a class="project-card-link" href="https://sae203.byethost10.com/?i=1" target="_blank" rel="noopener">
                <article class="project-card">
                    <img class="project-media" src="./icones/systeme_vote.avif" alt="Système de vote" width="800" height="220" loading="lazy">
        ...
        <div class="contact-layout">
            ...
            <aside class="contact-info">
                ...
                <div class="contact-info-body">
                    ...
                    <div class="contact-info-links">
                        <a class="contact-link contact-link-linkedin" href="https://www.linkedin.com/in/nicolas-boulloud/"
                        ...
                        <a class="contact-link contact-link-github" href="https://github.com/UnsoberDriver" target="_blank"
            ...
            <form class="contact-form<?php echo $feedback === 'success' ? ' show-success' : ($feedback === 'error' ? ' show-error' : ''); ?>"
        ...
        <nav>
            ...
            <div class="footer-top">
                ...
                <div class="footer-col footer-brand">
                    <p class="footer-name">Nicolas Boulloud</p>
                    <p class="footer-bio">
                        Student in Multimedia and Internet Technologies passionate about web development and creating
                        modern and accessible digital experiences.
                    </p>
                </div>
                ...
                <div class="footer-col">
                    <p class="footer-col-title">Contact &amp; Réseaux</p>
